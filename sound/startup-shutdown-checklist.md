...
- [ ] Gather wireless microphones that will be used and ensure they are working (if there is a stage manager they will hand them out)
- [ ] Test backtracks (if they will be used) and check for signal issue
  - Watch signal for click and guide to see if there is an issue, you'll know there is an issue if they both show clipping signal
  - If there is an issue change go to Setup > Audio and change the audio clock from 48k to 44 and then back to 48, that should fix the issue
