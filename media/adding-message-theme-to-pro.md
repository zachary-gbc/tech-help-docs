...
1. Open Theme Editor
2. Under Theme Selector Choose New Theme at bottom and input the appropriate name
3. Open Finder and navigate to Documents > ProPresenter > Themes
4. Move the folder of the theme you just created into the Message Series folder
5. Back in ProPresenter you will now need to choose that them from the dropdown to continue editing

# Adding Slides
The first slide is always a blank slide. This has nothing on it and is useful for adding a new message.
...
To make the background expand to fit the text within the box go to the Text tab on the right side of the screen, using the gear dropdown add margin to the top, bottom, right and left sides (maybe 50 each to start), change the scaling to be "Container up or down", and then check the Lines Only checkbox. Change the dropdown to be Max Line Width and then adjust the vertical and horizontal padding to look good around the text within the box.
